module.exports = Object.freeze({
  ...
  MESSAGE: {
    ...
    NOTICE_TITLE_LENGTH: 'お知らせは100文字以内で設定してください',
    NOTICE_TITLE_NULL: 'お知らせは必須項目です',
    NOTICE_LINK_NULL: 'リンク先URLは必須項目です',
    PUBLISHDATE_START_NULL: '公開開始日時は必須項目です',
    PUBLISHDATE_END_NULL: '公開終了日時は必須項目です',
  },
  ROUTE: {
    FRONT: '/front',
    FRONT_TOP: '/front/top',
